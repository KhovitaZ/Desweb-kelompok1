            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="flex items-center mb-2">
                    {selectedPayment.image && (
                        <img src={selectedPayment.image} alt={selectedPayment.bankName} className="h-6 w-15 mr-2"/>
                    )}
                ...
                <div className="text-sm">
                    ...
                    <div className="flex items-center justify-between bg-gray-200 p-2 rounded-lg">
                        ...
                        <button className="text-blue-500 font-medium hover:underline" onClick={() =>
                ...
                <div className="mt-4">
                    <details className="bg-gray-200 p-2 rounded-lg">
