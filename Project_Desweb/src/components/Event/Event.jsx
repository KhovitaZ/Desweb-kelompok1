...
const Event = () => {
  return (
    <div id="event" className="p-10 bg-white">
  ...
  <div className="grid sm:grid-cols-[1fr_minmax(100px,_1fr)] justify-between mt-10 gap-8">
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-row gap-3 items-center">
        <Link to="/subEvent" className="flex items-center gap-2">
    ...
    {/* Kolom Kanan */}
    <div className="flex justify-center items-center w-full h-[200px] md:h-[300px] lg:h-[372px] rounded-[20px] bg-gradient-to-r from-[#E3921C] to-[#E1D34C]">
